...
/**
 * @file range_pwm_dither.pio.h
 * @brief PIO program assembly and configuration for 1-cycle-per-count dithered RANGE PWM.
 */
 ...
 /**
  * @brief Gets default PIO configuration for the RANGE PWM dither program.
  */
